...
| FR-MINT-001 | BR-001,002,003,004,005,008,009 | Contract, Wallet, Chain Client | AT-MINT-001,002,003,005 unit/contract + deterministic exact-transaction and wallet-rejection browser coverage; live Base Sepolia pending | M2/M5 |
| FR-MINT-002 | BR-009,015 | Mint UX, Tx Resolver | AT-MINT-004 unit + deterministic pending-restore/success browser coverage; live Base Sepolia pending | M1/M5 |
