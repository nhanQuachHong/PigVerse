...
| FR-MINT-001 | BR-001,002,003,004,005,008,009 | Contract, Wallet, Chain Client | AT-MINT-001,002,003,005 unit/contract + deterministic exact-transaction, fresh-price, fresh-pause and wallet-rejection browser coverage; live Base Sepolia pending | M2/M5 |
